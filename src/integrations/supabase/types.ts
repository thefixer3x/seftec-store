  ...
  public: {
    Tables: {
      ...
      marketplace_bids: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketplace_bids_bidder_id_fkey"
            columns: ["bidder_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "marketplace_bids_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      trade_finance_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "trade_finance_documents_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "trade_finance_applications"
            referencedColumns: ["id"]
          },
        ]
      }
      trade_finance_transactions: {
        Row: {
          amount: number
          application_id: string
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "trade_finance_transactions_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "trade_finance_applications"
            referencedColumns: ["id"]
