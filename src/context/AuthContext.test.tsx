...
vi.mock('@/utils/auth-utils', () => ({
  handleSignIn: (...args: any[]) => mockHandleSignIn(...args),
  handleSignUp: (...args: any[]) => mockHandleSignUp(...args),
  handleSignOut: (...args: any[]) => mockHandleSignOut(...args),
  handleSendVerificationEmail: (...args: any[]) => mockHandleSendVerificationEmail(...args),
  handleResetPassword: (...args: any[]) => mockHandleResetPassword(...args),
  handleUpdateProfile: (...args: any[]) => mockHandleUpdateProfile(...args),
  handleSignInWithBiometric: (...args: any[]) => mockHandleSignInWithBiometric(...args),
  handleSignInWithOAuth: (...args: any[]) => mockHandleSignInWithOAuth(...args),
  handleSignInWithMagicLink: (...args: any[]) => mockHandleSignInWithMagicLink(...args),
  handleSetupMFA: (...args: any[]) => mockHandleSetupMFA(...args),
  handleVerifyMFA: (...args: any[]) => mockHandleVerifyMFA(...args),
  handleGetMFAFactors: (...args: any[]) => mockHandleGetMFAFactors(...args),
  handleGetUserSessions: (...args: any[]) => mockHandleGetUserSessions(...args),
  handleRemoveSession: (...args: any[]) => mockHandleRemoveSession(...args),
