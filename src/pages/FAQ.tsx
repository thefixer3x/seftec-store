    ...
    <div className="min-h-screen bg-white dark:bg-seftec-darkNavy pt-[56px]">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          {/* FAQ Category: Platform Overview */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-seftec-navy dark:text-white border-l-4 border-seftec-gold dark:border-seftec-teal pl-4 py-2">Platform Overview</h2>
            <Accordion type="single" collapsible className="bg-white dark:bg-seftec-darkNavy/30 rounded-lg shadow-sm">
              <AccordionItem value="what-is-seftec-store">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What is Seftec.Store?</AccordionTrigger>
              ...
              <AccordionItem value="who-can-use">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">Who can use Seftec.Store?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="key-features">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What are the key features of Seftec.Store?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="costs">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How much does it cost to use Seftec.Store?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
          ...
          {/* FAQ Category: Account Management */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-seftec-navy dark:text-white border-l-4 border-seftec-gold dark:border-seftec-teal pl-4 py-2">Account Management</h2>
            <Accordion type="single" collapsible className="bg-white dark:bg-seftec-darkNavy/30 rounded-lg shadow-sm">
              <AccordionItem value="create-account">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How do I create a business account?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="verification">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What documents are required for business verification?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="multiple-users">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">Can I add multiple users to my business account?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="manage-branches">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How do I manage multiple branches or locations?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
          ...
          {/* FAQ Category: Transactions & Payments */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-seftec-navy dark:text-white border-l-4 border-seftec-gold dark:border-seftec-teal pl-4 py-2">Transactions & Payments</h2>
            <Accordion type="single" collapsible className="bg-white dark:bg-seftec-darkNavy/30 rounded-lg shadow-sm">
              <AccordionItem value="payment-methods">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What payment methods are accepted?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="transaction-fees">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What are the transaction fees?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="refund-policy">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What is the refund and dispute policy?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="trade-finance">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How does the Trade Finance feature work?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
          ...
          {/* FAQ Category: Security & Compliance */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-seftec-navy dark:text-white border-l-4 border-seftec-gold dark:border-seftec-teal pl-4 py-2">Security & Compliance</h2>
            <Accordion type="single" collapsible className="bg-white dark:bg-seftec-darkNavy/30 rounded-lg shadow-sm">
              <AccordionItem value="data-security">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How is my business data protected?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="compliance">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">What compliance standards does Seftec.Store adhere to?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="fraud-protection">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How does Seftec.Store prevent fraud?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="secure-transactions">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How do you ensure transaction security?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
          ...
          {/* FAQ Category: Support & Integration */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-seftec-navy dark:text-white border-l-4 border-seftec-gold dark:border-seftec-teal pl-4 py-2">Support & Integration</h2>
            <Accordion type="single" collapsible className="bg-white dark:bg-seftec-darkNavy/30 rounded-lg shadow-sm">
              <AccordionItem value="customer-support">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How can I contact customer support?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="system-integration">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">Does Seftec.Store integrate with other business systems?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="training">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">Is training available for new users?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
              ...
              <AccordionItem value="ai-assistant">
                <AccordionTrigger className="text-lg font-medium text-seftec-navy dark:text-white px-6">How does the BizGenie AI assistant work?</AccordionTrigger>
                <AccordionContent className="px-6 text-gray-700 dark:text-gray-300">
