...
import {
  ...
  Menu,
  LifeBuoy,
  MapPinned          // icon needed for super-admin link
} from 'lucide-react';
...
/* ── standard sidebar items (visible to all users) ── */
const sidebarItems = [
...
const DashboardSidebar = () => {
  ...
  /* super-admin check */
  const isSuperAdmin =
    user?.email === 'superadmin@seftec.com' ||
    ...
    <div className="py-4 flex flex-col h-full">
      ...
      <div className="px-3 py-2">
        <div className="flex items-center mb-4 sm:mb-6 px-3">
          ...
          <h2 className="text-base sm:text-lg font-semibold text-seftec-navy dark:text-white">
            SEFTECHUB
          </h2>
        </div>
      </div>
            ...
            <>
              ...
              <div className="pt-2">
                ...
                <Link
                  ...
                  onClick={() => isMobile && setIsOpen(false)}
                >
                  <MapPinned className="h-4 w-4 sm:h-5 sm:w-5 mr-2 sm:mr-3" />
                  <span>Site Map</span>
                </Link>
              </div>
            </>
      ...
      <>
        <div className="flex items-center p-3 sm:p-4 border-b dark:border-seftec-darkNavy/50">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="left"
              className="p-0 w-[240px] sm:w-[280px] border-r border-border bg-seftec-slate dark:bg-seftec-darkNavy"
            >
              <SidebarContent />
            </SheetContent>
          </Sheet>
