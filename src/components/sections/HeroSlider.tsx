...
export default function HeroSlider() {
  ...
  const slides: Slide[] = [{
    id: "trade",
    variant: "light",
    tagline: t('hero.tagline', "Grow Smarter, Together"),
    headline: <>
          <span className="text-seftec-navy dark:text-white">{t('hero.trade_part1', 'Revolutionizing Global')}</span>{" "}
          <span className="bg-gradient-to-r from-seftec-gold to-orange-500 dark:from-seftec-teal dark:to-blue-400 bg-clip-text text-transparent">
            {t('hero.trade_part2', 'Trade with a Trusted AI-Powered Marketplace')}
          </span>
        </>,
    sub: t('hero.trade_subtitle', 'Trade with Trust, Pay with Confidence. Connect with verified businesses worldwide, transact securely, and access financing solutions all in one platform.'),
    primaryCta: {
      label: t('cta.get_started', 'Get Started'),
      href: "/register"
    },
    secondaryCta: {
      label: t('cta.book_demo', 'Book a Demo'),
      href: "/contact"
    },
    badges: [{
      icon: <Globe className="w-4 h-4" />,
      text: t('hero.badge_trade', "The Future of Secure B2B Trade & Vendor Payments"),
      className: "bg-white/90 text-seftec-navy border-seftec-navy/20"
    }, {
      icon: <Shield className="w-4 h-4" />,
      text: t('hero.badge_compliance', "ISO 20022 Compliant DeFi Leadership"),
    ...
    variant: "dark",
    headline: <>
          {t('hero.transform', 'Transform Your')}{' '}
          <span className="bg-gradient-teal-purple bg-clip-text text-transparent">
            {t('hero.business', 'Business')}
          </span>
          <br className="hidden sm:block" />
          <span className="block sm:inline"> {t('hero.with_ai', 'with AI')}</span>
        </>,
    sub: t('hero.subtitle', "Unlock enterprise-grade DeFi access, AI-powered marketplace solutions, and intelligent business automation in one comprehensive platform."),
    primaryCta: {
      label: t('cta.get_started_free', 'Get Started Free'),
      href: "/register"
    },
    secondaryCta: {
      label: t('cta.try_bizgenie', 'Try BizGenie AI'),
      href: "/bizgenie"
    },
    badges: [{
      icon: <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 animate-sparkle" />,
      text: t('hero.badge_ai', "AI-Powered Business Platform"),
          ...
          <div className="bg-white dark:bg-seftec-darkNavy rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="bg-seftec-slate/50 dark:bg-seftec-charcoal/50 rounded-lg p-3 sm:p-4">
                <div className="text-xs sm:text-sm text-seftec-navy/60 dark:text-white/60">{t('dashboard.revenue', 'Revenue')}</div>
              ...
              <div className="bg-seftec-slate/50 dark:bg-seftec-charcoal/50 rounded-lg p-3 sm:p-4">
                <div className="text-xs sm:text-sm text-seftec-navy/60 dark:text-white/60">{t('dashboard.growth', 'Growth')}</div>
