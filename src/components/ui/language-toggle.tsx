...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'nav.secured_by_ai': 'Secured by AI',
    'cta.sign_in': 'Sign In',
    'cta.sign_up': 'Sign Up',
    'cta.get_started': 'Get Started',
    'cta.get_started_free': 'Get Started Free',
    'cta.book_demo': 'Book a Demo',
    'cta.learn_more': 'Learn More',
    'cta.try_bizgenie': 'Try BizGenie AI',
    'hero.title': 'Transform Your Business with Advanced Technology',
    'hero.subtitle': 'Unlock enterprise-grade DeFi access, AI-powered marketplace solutions, and intelligent business automation in one comprehensive platform.',
    'hero.tagline': 'Grow Smarter, Together',
    'hero.trade_part1': 'Revolutionizing Global',
    'hero.trade_part2': 'Trade with a Trusted AI-Powered Marketplace',
    ...
    'hero.with_ai': 'with AI',
    'hero.badge_trade': 'The Future of Secure B2B Trade & Vendor Payments',
    'hero.badge_compliance': 'ISO 20022 Compliant DeFi Leadership',
    'hero.badge_ai': 'AI-Powered Business Platform',
    'trust.security': 'Enterprise Security',
    'trust.compliance': 'Global Compliance',
    'trust.support': '24/7 AI Support',
  ...
  ar: {
    ...
    'nav.cart': 'السلة',
    'nav.orders': 'طلباتي',
    'nav.secured_by_ai': 'محمي بالذكاء الاصطناعي',
    'cta.sign_in': 'تسجيل الدخول',
    'cta.sign_up': 'اشتراك',
    'cta.get_started': 'ابدأ الآن',
    'cta.get_started_free': 'ابدأ مجاناً',
    'cta.book_demo': 'احجز عرضاً توضيحياً',
    'cta.learn_more': 'اعرف المزيد',
    'cta.try_bizgenie': 'جرب BizGenie AI',
    'hero.title': 'تحويل أعمالك بالتكنولوجيا المتقدمة',
    'hero.subtitle': 'افتح الوصول للتمويل اللامركزي للمؤسسات، وحلول السوق المدعومة بالذكاء الاصطناعي، والأتمتة التجارية الذكية في منصة شاملة.',
    'hero.tagline': 'اعمل بذكاء أكبر، معاً',
    'hero.trade_part1': 'ثورة في التجارة العالمية',
    'hero.trade_part2': 'التداول مع سوق موثوق مدعوم بالذكاء الاصطناعي',
    ...
    'hero.transform': 'حول',
    'hero.business': 'أعمالك',
    'hero.with_ai': 'بالذكاء الاصطناعي',
    'hero.badge_trade': 'مستقبل التجارة الآمنة بين الشركات ومدفوعات الموردين',
    'hero.badge_compliance': 'قيادة التمويل اللامركزي المتوافقة مع ISO 20022',
    'hero.badge_ai': 'منصة أعمال مدعومة بالذكاء الاصطناعي',
    'trust.security': 'أمان المؤسسات',
    'trust.compliance': 'الامتثال العالمي',
    'trust.support': 'دعم الذكاء الاصطناعي 24/7',
  ...
  es: {
    ...
    'cta.get_started_free': 'Comenzar Gratis',
    'cta.book_demo': 'Reservar Demo',
    'cta.learn_more': 'Saber Más',
    'cta.try_bizgenie': 'Probar BizGenie AI',
    'hero.title': 'Transforma tu Negocio con Tecnología Avanzada',
    'hero.subtitle': 'Desbloquea acceso DeFi empresarial, soluciones de marketplace impulsadas por IA y automatización inteligente en una plataforma integral.',
    'hero.tagline': 'Crece más Inteligente, Juntos',
    'hero.trade_part1': 'Revolucionando el Comercio Global',
    'hero.trade_part2': 'con un Marketplace Confiable Impulsado por IA',
    'hero.transform': 'Transforma tu',
    'hero.business': 'Negocio',
    'hero.with_ai': 'con IA',
    'hero.badge_trade': 'El Futuro del Comercio B2B Seguro y Pagos a Proveedores',
    'hero.badge_compliance': 'Liderazgo DeFi Conforme a ISO 20022',
    'hero.badge_ai': 'Plataforma Empresarial Impulsada por IA',
    'trust.security': 'Seguridad Empresarial',
    'trust.compliance': 'Cumplimiento Global',
    'trust.support': 'Soporte IA 24/7',
