...
const ComingSoon: React.FC<ComingSoonProps> = ({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-seftec-slate dark:bg-seftec-darkNavy p-4">
      <div className="w-full max-w-md text-center p-6 sm:p-8 bg-white/70 dark:bg-white/5 shadow-lg rounded-lg border border-seftec-navy/10 dark:border-white/10 backdrop-blur-sm">
        <div className="flex justify-center mb-6">
          <Icons.logo className="h-10 w-10 sm:h-12 sm:w-12 text-seftec-gold dark:text-seftec-teal" />
        </div>
        
        <h1 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-seftec-navy dark:text-white">{title}</h1>
        
        <p className="text-sm sm:text-base text-seftec-navy/70 dark:text-white/70 mb-6 sm:mb-8">
          {message}
        </p>
